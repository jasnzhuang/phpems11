...
INSERT INTO `x2_app` VALUES ('plugin', '插件', 'app/core/styles/images/noimage.gif', 1, '');
...
INSERT INTO `x2_attach` VALUES (4, 'files/attach/images/content/20251102/17620796164731.png', 'header.png', 'png', 1762079616, 8660, '', 1, '');
INSERT INTO `x2_attach` VALUES (5, 'files/attach/images/content/20251105/17623256396097.xlsx', '40.xlsx', 'xlsx', 1762325639, 10455, '', 1, '');
INSERT INTO `x2_attach` VALUES (6, 'files/attach/images/content/20251105/17623257293284.xlsx', '40.xlsx', 'xlsx', 1762325729, 10455, '', 1, '');
INSERT INTO `x2_attach` VALUES (7, 'files/attach/images/content/20251105/17623258152033.xlsx', '40.xlsx', 'xlsx', 1762325815, 10455, '', 1, '');
INSERT INTO `x2_attach` VALUES (8, 'files/attach/images/content/20251105/17623258521101.xlsx', '40.xlsx', 'xlsx', 1762325852, 10455, '', 1, '');
INSERT INTO `x2_attach` VALUES (9, 'files/attach/images/content/20251105/17623258712576.xlsx', '40.xlsx', 'xlsx', 1762325871, 10455, '', 1, '');
INSERT INTO `x2_attach` VALUES (10, 'files/attach/images/content/20251105/17623259543715.xlsx', '40.xlsx', 'xlsx', 1762325954, 10455, '', 1, '');
INSERT INTO `x2_attach` VALUES (11, 'files/attach/images/content/20251105/17623259969409.xlsx', '40.xlsx', 'xlsx', 1762325996, 10455, '', 1, '');
...
INSERT INTO `x2_category` VALUES (11, 'content', 0, '友情链接', 'app/core/styles/images/noimage.gif', '', 0, 4, '', 'category_default', '', 0, 5, 0);
...
INSERT INTO `x2_category` VALUES (13, 'course', 0, '会计实务', 'app/core/styles/images/noimage.gif', '', 0, 5, '', 'category_default', '', 0, 0, 0);
INSERT INTO `x2_category` VALUES (14, 'content', 0, '联系我们', 'app/core/styles/images/noimage.gif', '', 0, 4, '', 'category_default', '', 0, 0, 0);
INSERT INTO `x2_category` VALUES (16, 'course', 0, '商务英语', 'app/core/styles/images/noimage.gif', '', 0, 0, '', 'category_default', '', 1, 0, 0);
INSERT INTO `x2_category` VALUES (17, 'course', 0, '英语', 'app/core/styles/images/noimage.gif', '', 0, 16, '', 'category_default', '', 0, 0, 0);
INSERT INTO `x2_category` VALUES (18, 'docs', 0, '英语', 'app/core/styles/images/noimage.gif', '', 0, 12, '', 'category_default', '', 0, 0, 0);
...
INSERT INTO `x2_category` VALUES (22, 'course', 0, '应用英语', 'app/core/styles/images/noimage.gif', '', 0, 0, '', 'category_default', '', 1, 0, 0);
INSERT INTO `x2_category` VALUES (47, 'content', 0, '测试新添加分类', 'app/core/styles/images/noimage.gif', '', 0, 4, '', 'category_default', '', 0, 0, 0);
...
CREATE TABLE `x2_cequeue`  (
  ...
  `ceqpubtime` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_cnttouser`  (
  ...
  `cturuserid` int NULL DEFAULT NULL,
  `cturcontentid` int NULL DEFAULT NULL,
  `cturtime` int NULL DEFAULT NULL,
...
INSERT INTO `x2_content` VALUES (5, 2, 35, 1, 'peadmin', '', 'aa', 'a', 'aa', 'files/attach/images/content/20210830/16302939588772.jpg', '', 0, 1630293959, 0, 'a', '', 0, 'content_default', '&lt;p&gt;a&lt;/p&gt;', 39);
...
INSERT INTO `x2_content` VALUES (7, 26, 35, 1, 'peadmin', '', '考试通知', 'tags', '关键字', 'files/attach/images/content/20251026/17614824851831.jpg', '', 1581913227, 1761482509, 0, '摘要', '', 0, 'content_default', '<p>内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容</p>', 24);
...
CREATE TABLE `x2_coupon`  (
  ...
  `couponusetime` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_course`  (
  ...
  `coursemoduleid` int NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `x2_course` VALUES (1, '测试', 14, 1, 34, 'files/attach/images/content/20190720/15635927397674.jpg', 1, 1467215744, 1729478673, 0, '', 'https://dev.phpems.net/phpems/petpl2/files/attach/images/content/20240319/17107963707266.mp4', '', '', '', '', 0, 0);
...
INSERT INTO `x2_course` VALUES (7, '课件7', 15, 1, 34, 'files/attach/images/content/20190720/15635931122951.jpg', 1, 1503560761, 1620458205, 0, '&lt;p&gt;课件7&lt;/p&gt;', '', '', '', '', 'files/attach/images/content/20210508/16204582045520.pdf', 0, 0);
INSERT INTO `x2_course` VALUES (34, '第一章', 40, 1, 0, 'app/core/styles/images/noimage.gif', 1, 1761728937, 0, 0, '', '', '', '', '', '', 0, 0);
INSERT INTO `x2_course` VALUES (35, '第二章', 40, 1, 0, 'app/core/styles/images/noimage.gif', 1, 1761729422, 0, 0, '', '', '', '', '', '', 0, 0);
INSERT INTO `x2_course` VALUES (36, '第二章第一节', 14, 1, 35, 'app/core/styles/images/noimage.gif', 1, 1761729433, 0, 0, '', '', '', '', '', '', 0, 0);
...
CREATE TABLE `x2_coursesubject`  (
  ...
  `csbasicid` int NULL DEFAULT 0,
  `cssubjectid` int NULL DEFAULT 0,
...
CREATE TABLE `x2_docs`  (
  ...
  `docsequence` int NULL DEFAULT NULL,
  ...
  `doclocktime` int NULL DEFAULT NULL,
  `docneedmore` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_enroll`  (
  ...
  `enrollbatid` int NULL DEFAULT NULL,
  `enrolluserid` int NULL DEFAULT NULL,
  ...
  `enrolltime` int NULL DEFAULT NULL,
  `enrollstatus` int NULL DEFAULT NULL,
  ...
  `enrollverify` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_enroll_bats`  (
  ...
  `enbmoduleid` int NULL DEFAULT NULL,
  `enbstarttime` int NULL DEFAULT NULL,
  `enbendtime` int NULL DEFAULT NULL,
  `enbintro` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `enbtime` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_examhistory_log`  (
  ...
  `ehluserid` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_exercise`  (
  ...
  `exertype` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  INDEX `exertype`(`exertype`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = FIXED;

-- ----------------------------
-- Records of x2_exercise
-- ----------------------------
INSERT INTO `x2_exercise` VALUES (3, 0, 0, 0, 0, 0, NULL);
INSERT INTO `x2_exercise` VALUES (4, 0, 0, 0, 0, 0, NULL);
INSERT INTO `x2_exercise` VALUES (5, 0, 0, 0, 0, 0, NULL);
INSERT INTO `x2_exercise` VALUES (6, 0, 0, 0, 0, 0, NULL);
INSERT INTO `x2_exercise` VALUES (7, 0, 0, 0, 0, 0, NULL);
INSERT INTO `x2_exercise` VALUES (8, 0, 0, 0, 0, 0, NULL);
INSERT INTO `x2_exercise` VALUES (9, 0, 0, 0, 0, 0, NULL);
...
INSERT INTO `x2_favor` VALUES (2, 1, 1, 6368, 1761728415);
INSERT INTO `x2_favor` VALUES (3, 1, 1, 0, 1761728599);
...
) ENGINE = MyISAM AUTO_INCREMENT = 260 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = FIXED;

-- ----------------------------
-- Records of x2_log
-- ----------------------------
INSERT INTO `x2_log` VALUES (254, 1, 1, 1664423199, 1, 1729479948, 20);
INSERT INTO `x2_log` VALUES (255, 1, 20, 1666060258, 0, 0, 2437);
INSERT INTO `x2_log` VALUES (256, 1, 7, 1729481412, 0, 0, 0);
INSERT INTO `x2_log` VALUES (257, 1, 34, 1761728985, 0, 0, 0);
INSERT INTO `x2_log` VALUES (258, 1, 35, 1761729441, 0, 0, 0);
INSERT INTO `x2_log` VALUES (259, 1, 36, 1762080745, 0, 0, 0);
...
INSERT INTO `x2_module_fields` VALUES (18, 'user', 9, 0, 'userpassport', '身份证号', '24', '', 'varchar', 'text', 'class=form-control', '', '', 0, '', ',,', 1, 1);
...
CREATE TABLE `x2_navs`  (
  ...
  `navsequence` int NULL DEFAULT NULL,
  `navstatus` int NULL DEFAULT NULL,
...
INSERT INTO `x2_opencourse` VALUES (9, 1, 12, 1761728962, 1793264962);
...
INSERT INTO `x2_orders` VALUES ('20251029164935593', '考试系统充值 10 元', '', '', 10.00, 1, 'a:1:{s:8:\"username\";N;}', 1, 0.00, 1761727775, 0, 0, 0, '', '', '', '', '');
INSERT INTO `x2_orders` VALUES ('20251029165259244', '考试系统充值 10 元', '', '', 10.00, 1, 'a:1:{s:8:\"username\";N;}', 1, 0.00, 1761727979, 0, 0, 0, '', '', '', '', '');
INSERT INTO `x2_orders` VALUES ('20251029165337482', '考试系统充值 10 元', '', '', 10.00, 1, 'a:1:{s:8:\"username\";N;}', 1, 0.00, 1761728017, 0, 0, 0, '', '', '', '', '');
...
-- ----------------------------
INSERT INTO `x2_plugins` VALUES (1, 'demo', NULL, 1);
...
) ENGINE = MyISAM AUTO_INCREMENT = 9616 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = FIXED;

-- ----------------------------
-- Records of x2_quest2knows
-- ----------------------------
INSERT INTO `x2_quest2knows` VALUES (9603, 9758, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9604, 9759, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9605, 9760, 2, 0);
INSERT INTO `x2_quest2knows` VALUES (9606, 9761, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9607, 9762, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9608, 9763, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9609, 9764, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9610, 9765, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9611, 9766, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9612, 9767, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9613, 9768, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9614, 9769, 1, 0);
INSERT INTO `x2_quest2knows` VALUES (9615, 9770, 1, 0);
...
CREATE TABLE `x2_questionanalysis`  (
  ...
  `qabasicid` int NULL DEFAULT NULL,
  `qaquestionid` int NULL DEFAULT NULL,
  `qauserid` int NULL DEFAULT NULL,
  `qanumber` int NULL DEFAULT NULL,
  `qarightnumber` int NULL DEFAULT NULL,
  `qawrongnumber` int NULL DEFAULT NULL,
  `qalasttime` int NULL DEFAULT NULL,
  `qafirststatus` int NULL DEFAULT NULL,
  `qalaststatus` int NULL DEFAULT NULL,
  `qarate` int NULL DEFAULT NULL,
  `qaqnparent` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_questionrows`  (
  ...
  `qrdeltime` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_questions`  (
  ...
  `questiondeltime` int NULL DEFAULT NULL,
...
) ENGINE = MyISAM AUTO_INCREMENT = 9771 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `x2_questions` VALUES (9759, 1, '关于容量瓶的使用，下列操作正确的是', 1, 'peadmin', '', '<p>A、容量瓶长期存放溶液</p><p>B、用浓硫酸溶解固体试剂后立即转移至容量瓶</p><p>C、容量瓶干燥后未冷却直接配制标准溶液</p><p>D、定容时用胶头滴管逐滴加入蒸馏水至凹液面最低处与刻度线相切</p>', 0, 'D', '容量瓶作为精密量器，使用时需注意：1. 不能长期储存溶液（A错误），应转移到试剂瓶中保存；2. 热溶液需冷却至室温再转移（B、C错误），否则体积不准确；3. 定容时需用胶头滴管精细调整液面（D正确），确保体积精确。', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1761889379, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9760, 1, '关于容量瓶的使用方法，下列叙述正确的是', 1, 'peadmin', '', '<p>A、容量瓶可长期存放配制好的标准溶液</p><p>B、容量瓶可用烘箱在105℃下烘干</p><p>C、容量瓶可加热溶解固体试剂</p><p>D、定容时视线应与凹液面最低处水平</p>', 0, 'D', '容量瓶作为精密量器，使用时需注意：A错误，容量瓶不宜长期存放溶液，特别是碱性溶液会腐蚀瓶塞；B错误，容量瓶不能烘干，否则会导致体积变化；C错误，容量瓶不能加热或用于溶解操作；D正确，定容时视线应与凹液面最低处保持水平，以确保体积准确。', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"2\";s:5:\"knows\";s:16:\"测试2知识点\";}}', 1761889566, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9761, 3, '厂商上门维修,发现机房维修笔记本缺少维修使用软件,厂商工程师直接把软件发送给驻场人员,驻场人员直接将软件安装在维修电脑上', 0, '', '', '【A】正确 <br>【B】错误', 2, 'B', '', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325816, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9762, 3, '掉电机柜空开跳闸,为尽快恢复机柜双路供电,驻场IT工程师直接对跳闸空开进行合闸', 0, '', '', '【A】正确 <br>【B】错误', 2, 'B', '', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325816, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9763, 1, '1+1的电源冗余模式中，当其中一个电源模块发生故障无法输出功率时，另一个电源模块会？', 0, '', '', '【A】唤醒故障电源模块 <br>【B】承担全部输出功率 <br>【C】启动自我保护，停止输出功率 <br>【D】承担50%功率输出', 4, 'B', '1+1电源冗余正常工作是两个电源各承担50%功率，1个电源故障时，另一个电源承担所有功率负载', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325816, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9764, 1, '5类双绞线（CAT5）的最高传输速率为', 0, '', '', '【A】100Mb/S <br>【B】155M/S <br>【C】250Mb/S <br>【D】600Mb/S', 4, 'A', '区分五类、超五类（CAT-5E）和六类线的传输速率。五类线最高频率带宽为100MHz，最高传输率为100Mbps，用于语音传输和最高传输速率为100Mbps的数据传输。', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325816, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9765, 3, 'Aliserverpx04-j108机型JBOD带外网络问题排查,观察JBOD带外网口数据灯闪烁状态,状态灯常亮,表示带外口与上联带外交换机处于正常连接状态', 0, '', '', '【A】正确 <br>【B】错误', 2, 'A', '', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325816, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9766, 3, '厂商上门维修,发现机房维修笔记本缺少维修使用软件,厂商工程师直接把软件发送给驻场人员,驻场人员直接将软件安装在维修电脑上', 0, '', '', '【A】正确 <br>【B】错误', 2, 'B', '', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325997, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9767, 3, '掉电机柜空开跳闸,为尽快恢复机柜双路供电,驻场IT工程师直接对跳闸空开进行合闸', 0, '', '', '【A】正确 <br>【B】错误', 2, 'B', '', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325997, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9768, 1, '1+1的电源冗余模式中，当其中一个电源模块发生故障无法输出功率时，另一个电源模块会？', 0, '', '', '【A】唤醒故障电源模块 <br>【B】承担全部输出功率 <br>【C】启动自我保护，停止输出功率 <br>【D】承担50%功率输出', 4, 'B', '1+1电源冗余正常工作是两个电源各承担50%功率，1个电源故障时，另一个电源承担所有功率负载', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325997, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9769, 1, '5类双绞线（CAT5）的最高传输速率为', 0, '', '', '【A】100Mb/S <br>【B】155M/S <br>【C】250Mb/S <br>【D】600Mb/S', 4, 'A', '区分五类、超五类（CAT-5E）和六类线的传输速率。五类线最高频率带宽为100MHz，最高传输率为100Mbps，用于语音传输和最高传输速率为100Mbps的数据传输。', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325997, 1, '', 0, 0, 1, '', 0);
INSERT INTO `x2_questions` VALUES (9770, 3, 'Aliserverpx04-j108机型JBOD带外网络问题排查,观察JBOD带外网口数据灯闪烁状态,状态灯常亮,表示带外口与上联带外交换机处于正常连接状态', 0, '', '', '【A】正确 <br>【B】错误', 2, 'A', '', 'a:1:{i:0;a:2:{s:7:\"knowsid\";s:1:\"1\";s:5:\"knows\";s:15:\"演示知识点\";}}', 1762325997, 1, '', 0, 0, 1, '', 0);
...
CREATE TABLE `x2_recorddata`  (
  ...
  `rduserid` int NULL DEFAULT NULL,
  `rdsubjectid` int NULL DEFAULT NULL,
  `rddata` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `rdtime` int NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `x2_recorddata` VALUES (2, 1, 1, 'a:1:{i:1;a:1:{i:1;a:1:{s:8:\"question\";a:1:{i:9758;i:9758;}}}}', 1761555787);
...
-- ----------------------------
INSERT INTO `x2_session` VALUES ('399d6a8c0a64632b06082ca1ace5af58', 1, 'peadmin', '244153a2599be7685c32d2281f57ae67', '127.0.0.1', 0, 1, '', '', 1762431255, 1762431255, 1762433705, 0);
INSERT INTO `x2_session` VALUES ('c041eaa430efc6a1a96a3319d5bce25f', 1, 'peadmin', '244153a2599be7685c32d2281f57ae67', '127.0.0.1', 0, 1, '1', '', 1762325521, 1762325521, 1762411448, 0);
...
CREATE TABLE `x2_survey`  (
  ...
  `svytime` int NULL DEFAULT NULL,
  `svytype` int NULL DEFAULT NULL,
  `svydescribe` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `svystime` int NULL DEFAULT NULL,
  `svyendtime` int NULL DEFAULT NULL,
  `svyuserid` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_survey_history`  (
  ...
  `syhyuserid` int NULL DEFAULT NULL,
  `syhysvyid` int NULL DEFAULT NULL,
  ...
  `syhytime` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_survey_node`  (
  ...
  `synesvyid` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_survey_questions`  (
  ...
  `syqnsvyid` int NULL DEFAULT NULL,
  `syqnsyneid` int NULL DEFAULT NULL,
  `syqnquestion` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `syqnquestiontype` int NULL DEFAULT NULL,
  `syqnquestionselect` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `syqnquestionselectnumber` int NULL DEFAULT NULL,
...
CREATE TABLE `x2_user`  (
  ...
  `userdisable` tinyint NULL DEFAULT NULL,
...
INSERT INTO `x2_user` VALUES (3, '', '', 'testcoin', 'testcoin@163.com', '96e79218965eb72c92a549dd5a330112', 10, '127.0.0.1', 1762430772, 0, 0, 8, 0, '', '', '', '', '', '', '', '', '', '', 0, 0, '');
...
INSERT INTO `x2_user_log` VALUES (17, 1, '127.0.0.1', 'pc', 1761556722);
INSERT INTO `x2_user_log` VALUES (18, 1, '127.0.0.1', 'pc', 1761724020);
INSERT INTO `x2_user_log` VALUES (19, 1, '127.0.0.1', 'pc', 1761887477);
INSERT INTO `x2_user_log` VALUES (20, 1, '127.0.0.1', 'pc', 1762072270);
INSERT INTO `x2_user_log` VALUES (21, 1, '127.0.0.1', 'pc', 1762325521);
INSERT INTO `x2_user_log` VALUES (22, 1, '127.0.0.1', 'pc', 1762417116);
INSERT INTO `x2_user_log` VALUES (23, 1, '127.0.0.1', 'pc', 1762430721);
INSERT INTO `x2_user_log` VALUES (24, 1, '127.0.0.1', 'pc', 1762431255);
