...
class action extends app
{
	...
	private function addfield()
	{
		...
		if(M('ev')->get('insertfield'))
		{
			...
			if(is_array($args['fieldforbidactors']))$args['fieldforbidactors'] = ','.implode(',',is_array($args['fieldforbidactors'])?$args['fieldforbidactors']:[]).',';
	...
	private function modifyfield()
	{
		...
		{
			$args = M('ev')->post('args');
			$args['fieldforbidactors'] = is_array($args['fieldforbidactors'])?','.implode(',',is_array($args['fieldforbidactors'])?$args['fieldforbidactors']:[]).',':'';
