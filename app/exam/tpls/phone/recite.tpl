		...
		<div class="page-content header">
			...
			<div class="list-box bg">
				<ol>
					...
					<li class="unstyled">
						<a href="index.php?exam-phone-recite-paper&knowsid={x2;v:know}" class="ajax">
							<div class="rows info">
								<h5 class="title">{x2;$knows[v:know]['knows']}</h5>
								<p class="intro">共 {x2;eval: echo array_sum($knows[v:know]['knowsnumber'])} 题{x2;if:$record[v:know]}，上次背到第 {x2;$record[v:know]['exernumber']} 题{x2;endif}，点击继续练习</p>
							</div>
						</a>
					</li>
                    {x2;endtree}
