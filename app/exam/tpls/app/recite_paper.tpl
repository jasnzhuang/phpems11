	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="index.php?exam-app-recite-reporterror" method="post" class="form-horizontal" id="reporterrorform">
					<fieldset>
...
<script type="text/javascript">
    $(document).ready(function(){
        submitAjax({url:"index.php?exam-app-recite-ajax-questions&knowsid={x2;$knows['knowsid']}","target":"questionpanel"});
        ...
        $('body').delegate('.jump.badge','click',function(){
            ...
            if($number <= 0)return ;
            submitAjax({url:"index.php?exam-app-recite-ajax-questions&knowsid={x2;$knows['knowsid']}&number="+$number,"target":"questionpanel"});
		});
