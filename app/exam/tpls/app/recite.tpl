						...
						<ul class="list-unstyled list-txt">
							...
							<li class="border">
								...
								<span class="tool pull-right">
									...
									{x2;if:$record[v:know]}
									<a class="btn btn-default" href="index.php?exam-app-recite-paper&knowsid={x2;v:know}">继续背题</a>
                                    {x2;else}
									<a class="btn btn-default" href="index.php?exam-app-recite-paper&knowsid={x2;v:know}">开始背题</a>
									{x2;endif}
									{x2;else}
								...
								<span class="tool pull-right">
									<span>共 {x2;eval: echo array_sum($knows[v:know]['knowsnumber'])} 题{x2;if:$record[v:know]}，上次背到第 {x2;$record[v:know]['exernumber']} 题{x2;endif}</span>
								</span>
							</li>
                            {x2;endtree}
						</ul>
